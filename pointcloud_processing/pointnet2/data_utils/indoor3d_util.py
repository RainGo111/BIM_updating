...
DATA_PATH = os.path.join(ROOT_DIR, 'data','mys3dis')
# g_classes = [x.rstrip() for x in open(os.path.join(BASE_DIR, 'meta/class_names.txt'))]
g_classes = [x.rstrip() for x in open(os.path.join(BASE_DIR, 'meta/my_class_names.txt'))]
...
g_class2color = {'nonepipe':	[255,0,0],
                 'pipe':	[0,255,0]
                 }
                 
# g_easy_view_labels = [7,8,9,10,11,1]
g_easy_view_labels = [1,2]
