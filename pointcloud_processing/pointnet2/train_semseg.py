...
def parse_args():
    ...
    parser.add_argument('--step_size', type=int, default=15, help='Decay step for lr decay [default: every 10 epochs]')
...
def main(args):
    ...
    root = 'data/my_stanford_indoor3d/'
